...
var ColorPicker = (function (GLOB) {
	...
	var DOC            = GLOB.document,
		...
		createPalette = function (pickerContainer, srcPicker, srcInput) {
            ...
            pickerContainer.appendChild(palette);           
			return palette;
		};
	...
	return {
		 ...
		 * @return ColorPicker
		 */
		insertInto : function (container, element, name, sel, offsX, offsY) {
		
			var picker		= DOC.createElement("DIV"),
				hideInput	= DOC.createElement("INPUT"),
				palette		= createPalette(container, picker, hideInput),
                selected    = sel   || "#FFFFFF",
				oX			= offsX || 1,
				oY			= offsY || 1;
            ...
            container.insertBefore(hideInput, picker);
